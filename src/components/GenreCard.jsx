...
function GenreCard({GenreCardimg}){
    ...
    return(
           <div className="genre-card" style={{height:"190px",display:"flex",backgroundColor:"white",textDecoration:"none",color:"black"}}>
            <Link to="/Anukriti/aboutStory" className="genre-card-right" style={{
            ...
            opacity:"0.95",
            }}> <span style={{position:"relative",top:"163px",left:"4%",color:"white",fontSize:"14px",fontWeight:"500"}}><MdOutlineLibraryBooks style={{fontSize:"16px",marginRight:"7px"}}/>52 parts</span> </Link>
            <div className="genre-card-right" style={{width:"80%",height:"90%",marginRight:"10px",marginTop:"6px"}}>
              ...
              <Link to="/Anukriti/aboutStory" className="genre-title" style={{fontWeight:"600",width:"80%",marginBottom:"0px"}}>Love Is Love </Link>
              {(library &&  <CgPlayListCheck style={{fontSize:"30px",marginTop:"2px"}} onClick={handleLibrary}/>) || (!library && <MdOutlinePlaylistAdd style={{fontSize:"30px",marginTop:"2px"}} onClick={handleLibrary}/>)}
                ...
                <Link to="/Anukriti/aboutStory" className="genre-desc">This love story is just fabulous like what a true love story should be ? much enjooyed keep Writing with your interest beloved my dear,god may bless you and you achiev very high position in your life</Link>
